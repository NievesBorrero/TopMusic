...
public class TestTopMusic {
	...
	public static void main(String[] args) {
		Menu menu = new Menu("OPCIONES:", new String[] { "añadir cancion", "Mostrar lista", "subir puesto de cancion",
			"Bajar puesto de cancion", "Sacar del Top 10", "Mostrar cancion en el puesto numero 1",
